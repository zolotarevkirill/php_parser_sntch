...
foreach ($result_section as $key => $value) {
	...
	$q_insert_category = "INSERT INTO `lnvkey5p_cscart`.`cscart_categories` (`category_id`, `parent_id`, `id_path`, `position`, `parse_id`) VALUES ('{$value[1]}', '{$value[0]}', '{$path}', '{$key}', '{$value[1]}')";
